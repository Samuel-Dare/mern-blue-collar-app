...
// const createSendToken = (user, statusCode, req, res, newProfessional) => {
...
// //   const newUser = await User.create(signupReqObj(req));
...
// //       // user is an array, extract the first user
// //       user = user[0];
// //     } else {
// //       // If user exists, retrieve the user details
// //       user = req.user;
// //     }
...
// //     createSendToken(user, 201, req, res, newProfessional);
// //   } catch (error) {
...
//   const confirmationUrl = `${req.protocol}://${req.get("host")}/confirm-email/${
...
//   // 3) Check if user's email is confirmed
